...
public class ClassSpy {
    ...
    public void testClassSpy() {
        ClassSpy.spy("ExampleTestedClass", ClassMember.CONSTRUCTOR.toString());
    }
...
class ExampleTestedClass {
    ...
    public ExampleTestedClass() {
    }

    public ExampleTestedClass(String text, int counter) {
        super();
        this.text = text;
