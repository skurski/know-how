...
public abstract class AbstractMapImpl<K,V> implements Map<K,V> {
    ...
    public Set<K> keySet() {
        if (keySet == null) {
            keySet = new AbstractSet<K>() {
                ...
                public int size() {
                    return AbstractMapImpl.this.size();
                }

                public boolean isEmpty() {
                    return AbstractMapImpl.this.isEmpty();
                }

                public void clear() {
                    AbstractMapImpl.this.clear();
                }

                public boolean contains(Object k) {
                    return AbstractMapImpl.this.containsKey(k);
                }
            };
        }
        return keySet;
        ...
        if (values == null) {
            values = new AbstractCollection<V>() {
                ...
                public boolean contains(Object v) {
                    return AbstractMapImpl.this.containsValue(v);
                }
            };
        }
        return values;
    ...
    /**
     * Returns a shallow copy of this <tt>AbstractMapImpl</tt> instance: the keys
     * and values themselves are not cloned.
     *
     * @return a shallow copy of this map
     */
    protected Object clone() throws CloneNotSupportedException {
        AbstractMapImpl<K,V> result = (AbstractMapImpl<K,V>)super.clone();
        result.keySet = null;
        result.values = null;
        return result;
    }
